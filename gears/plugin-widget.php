...
/**
 * Alpine PhotoTile for SmugMug: WP_Widget
 *
 * @ Since 1.1.1
 * @ Updated 1.2.3
 */

class Alpine_PhotoTile_for_SmugMug extends WP_Widget { 
  public $alpinebot;
  
	function Alpine_PhotoTile_for_SmugMug() {
    $this->alpinebot = new PhotoTileForSmugMugBot();
    $bot = $this->alpinebot;
